...
int main() {
    ...
    serv_addr.sin_addr.s_addr = inet_addr("192.185.1.1");
    ...
    int client_socket;
    if ((client_socket = accept(server_socket, (struct sockaddr *)&serv_addr, (socklen_t*)&client_socket)) < 0) {
    ...
    string decrypted_message = des_process(received_message, "133457799BBCDFF1", false);
