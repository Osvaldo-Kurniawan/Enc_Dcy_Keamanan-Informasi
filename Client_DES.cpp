...
int main() {
    string message;
    string key = "133457799BBCDFF1";  // Fixed key on the client side
    bool encrypt;
    ...
    // Proses DES Encrypt
    string encrypted_message = des_process(input_message, key, true);
    ...
    server_address.sin_addr.s_addr = inet_addr("192.185.1.1");
